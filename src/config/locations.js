...
export const STAGES = [
  {
    ...
    gupta: {
      ...
      clue: "report to the High Road moon base first. Find J.J. Moon's — the only place where Gupta's failed Maverick costume still makes sense.",
    },
    gohil: {
      missionTitle: "Permission from Bapuji",
      terminalLines: [
      ...
      clue: "Wembley High Road pe moon base dhundo — J.J. Moon's. Guinness protocol comes first.",
    },
  },
  {
    id: "spoons",
    ...
    gupta: {
      ...
      clue: "Food protocol complete. Next, head west to the place with pool tables, punch machines, reclining seats, and one very questionable skipped lecture. Royale Leisure Park. Western Avenue.",
    },
    gohil: {
      missionTitle: "The Maverick Moon-Landing",
      terminalLines: [
      ...
      clue: "Food protocol complete. Next, head west to the place where you taught Gupta pool, won everything, and still somehow agreed to a film that was not worth bunking David's class. Royale Leisure Park. Western Avenue.",
    },
  },
  {
    id: "wembley",
